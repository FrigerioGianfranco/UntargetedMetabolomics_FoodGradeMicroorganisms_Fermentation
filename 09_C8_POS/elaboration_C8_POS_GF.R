...
## 3 Input data
###
mL <- read_input_file(feature_file = "Normalized_0_20211228917_NoBIBIF_onlyKnown_reduced_POS.txt", sample_file = "meta.txt")
...
# removing outliers !
mL <- remove_samples(mRList = mL, ids = c("x011_QC1_C8_pos", "x012_QC2_C8_pos", "x100_MIC_LAC_PLAN_rbiol1_rtech3_C8_pos"), column = "id")
...
mR_library <- select_library(source = "MS-DIAL", column = "LipC8", mode = "POS", accept_RI=10)
...
data_per_ANOVA_GF <- transpose_feat_table(metab_stat_w_features[,c("Feature_ID",
                                                                   "x017_MIC_LAC_AMYL_rbiol2_rtech1_C8_pos", "x022_MIC_LAC_KEFI_rbiol2_rtech1_C8_pos", 
                                                                   "x026_MIC_BIF_BREV_rbiol2_rtech1_C8_pos", "x028_MIC_LAC_KEFI_rbiol1_rtech1_C8_pos",
                                                                   "x032_MIC_LAC_SALI_rbiol1_rtech1_C8_pos", "x033_MIC_LAC_PLAN_rbiol1_rtech1_C8_pos",
                                                                   "x038_MIC_LAC_AMYL_rbiol1_rtech1_C8_pos", "x041_MIC_LAC_SALI_rbiol2_rtech1_C8_pos",
                                                                   "x042_MIC_BIF_BREV_rbiol1_rtech1_C8_pos", "x043_MIC_LAC_PLAN_rbiol2_rtech1_C8_pos",
                                                                   "x047_MIC_BIF_BREV_rbiol1_rtech2_C8_pos", "x048_MIC_LAC_AMYL_rbiol2_rtech2_C8_pos",
                                                                   "x049_MIC_BIF_BREV_rbiol2_rtech2_C8_pos", "x053_MIC_LAC_PLAN_rbiol2_rtech2_C8_pos",
                                                                   "x057_MIC_LAC_KEFI_rbiol1_rtech2_C8_pos", "x058_MIC_LAC_PLAN_rbiol1_rtech2_C8_pos",
                                                                   "x059_MIC_LAC_KEFI_rbiol2_rtech2_C8_pos", "x067_MIC_LAC_SALI_rbiol1_rtech2_C8_pos",
                                                                   "x068_MIC_LAC_AMYL_rbiol1_rtech2_C8_pos", "x073_MIC_LAC_SALI_rbiol2_rtech2_C8_pos",
                                                                   "x078_MIC_LAC_SALI_rbiol1_rtech3_C8_pos", "x079_MIC_BIF_BREV_rbiol1_rtech3_C8_pos",
                                                                   "x080_MIC_LAC_KEFI_rbiol2_rtech3_C8_pos", "x082_MIC_LAC_KEFI_rbiol1_rtech3_C8_pos",
                                                                   "x087_MIC_LAC_SALI_rbiol2_rtech3_C8_pos", "x090_MIC_LAC_AMYL_rbiol2_rtech3_C8_pos",
                                                                   "x092_MIC_LAC_PLAN_rbiol2_rtech3_C8_pos", "x097_MIC_LAC_AMYL_rbiol1_rtech3_C8_pos",
                                                                   "x101_MIC_BIF_BREV_rbiol2_rtech3_C8_pos")]) %>%
