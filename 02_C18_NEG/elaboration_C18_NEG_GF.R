...
## 3 Input data
###
mL <- read_input_file(feature_file = "Normalized_0_2021122993_No_BIF_BIFI.txt", sample_file = "meta.txt")
...
metab_boxplot(mRList = mL_norm, col_by="class", group="class", features = "F2")
...
mR_library <- select_library(source = "margheRita", column = "RPLong", mode = "NEG", accept_RI=10)
...
# visualize_associated_spectra(mRList = mL_norm, mR_library = mR_library, metabolite_id = "L124")


# h_map_MSMS_comparison(mL_norm, metab_id = "L1053", feature_id = "F403", RI_difference = 20)




#### heatmap con i nomi dei metaboliti
