...
restuls_BEHPOS_imported <- read_csv("metab_stat_w_features_known_only_sign_w_diff_more_BEHPOS.csv")
restuls_C18NEG_imported <- read_csv("metab_stat_w_features_known_only_sign_w_diff_more_C18NEG.csv")
restuls_C18POS_imported <- read_csv("metab_stat_w_features_known_only_sign_w_diff_more_C18POS.csv")
...
export_the_table(results_combined, "results_combined", "txt")
export_the_table(results_combined, "results_combined", "csv")
export_the_table(results_combined, "results_combined", "xlsx")
